...
void main(void)
{
	...
	MCAL_GPIO_SetPinMode(GPIO_PORTA, GPIO_PIN1, GPIO_OUTPUT_PUSH_PULL_2MHZ); // TFT: D/C pin
	MCAL_GPIO_SetPinMode(GPIO_PORTA, GPIO_PIN2, GPIO_OUTPUT_PUSH_PULL_2MHZ); // TFT: RST pin
	...
	tft1.TFT_DCPin.TFT_Pin  = GPIO_PIN1;
	tft1.TFT_RESPin.TFT_Pin = GPIO_PORTA;
	tft1.TFT_RESPin.TFT_Pin = GPIO_PIN2;
	TFT_Init(&tft1);
